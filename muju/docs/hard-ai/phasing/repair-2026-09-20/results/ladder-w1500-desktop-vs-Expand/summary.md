# Ladder: hard@desktop vs Expand

- status: **complete**
- work: `wall:1500`, handicaps: `0`, seed: 34, shards: 8
...
- Elo (A vs B): 293.0 [224.4, 387.7], LOS 100.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1011.2 b=0.8
- loadAvgMean (1-min, per game, start and end): 8.99
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 735 | 1505 | 1564 | 93 | 5 | 0.68% | 0 | 0 |
| Expand | 735 | 3 | 18 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 735 | 97 | 13.20% | 32 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 16/16 | 32 | 0.844 | 22/10/0 | 293.0 |
