...
- status: **complete**
- work: `wall:1500`, handicaps: `0`, seed: 20260921, shards: 8
...
- A record (W/D/L): 4/0/60
- adjudicationRate: 0.00%
- **VOID** timing.b.overrunRate 10.01% (77/769 turns) for arm b = aiv2-hard exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- Elo (A vs B): -470.4 [-912.5, -346.5], LOS 0.0%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1095.9 b=1420.3
- loadAvgMean (1-min, per game, start and end): 12.08
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 741 | 1508 | 1566 | 139 | 14 | 1.89% | 0 | 0 |
| aiv2-hard | 769 | 1520 | 1596 | 606 | 77 | 10.01% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 741 | 140 | 18.89% | 62 | 0 |
