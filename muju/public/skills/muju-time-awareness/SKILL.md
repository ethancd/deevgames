...
one free delay across actions, upkeep and preparation; then your personal bank
...
The full-turn ending command is `END_PLACE_PHASE`.
...
1. Read the clock, `clockPressure` and briefing. Find a satisfactory legal batch
   early, including all required phases and the full-turn ending command.
