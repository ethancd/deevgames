import type { ActionRequest, RoomAdmission, RoomConnection, RoomSnapshot } from './types';
...
export async function roomRequest<T>(serverUrl: string, path: string, body?: unknown, token?: string, signal?: AbortSignal): Promise<T> {
