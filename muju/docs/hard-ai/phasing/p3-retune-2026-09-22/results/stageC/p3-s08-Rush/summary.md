...
- Elo (A vs B): -27.2 [-104.0, 47.0], LOS 23.6%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1099.1 b=9.4
- loadAvgMean (1-min, per game, start and end): 10.97
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 1828 | 1900 | 2364 | 0 | 0 | n/a | 0 | 0 |
| Rush | 1843 | 34 | 91 | 0 | 0 | n/a | n/a | n/a |
