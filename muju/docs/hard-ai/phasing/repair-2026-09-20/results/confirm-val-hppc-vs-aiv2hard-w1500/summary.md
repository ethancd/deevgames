# Ladder: hard@ablate:hand-priors-pc vs aiv2-hard

- status: **complete**
- work: `wall:1500`, handicaps: `0`, seed: 52, shards: 8
...
- A record (W/D/L): 49/0/15
- adjudicationRate: 0.00%
- **VOID** timing.b.overrunRate 7.23% (73/1010 turns) for arm b = aiv2-hard exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- Elo (A vs B): 205.6 [115.0, 332.7], LOS 100.0%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1015.2 b=1479.5
- loadAvgMean (1-min, per game, start and end): 8.98
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:hand-priors-pc | 1023 | 1511 | 1558 | 245 | 24 | 2.35% | 0 | 0 |
| aiv2-hard | 1010 | 1517 | 1692 | 897 | 73 | 7.23% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:hand-priors-pc | 1023 | 246 | 24.05% | 64 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 32/32 | 64 | 0.766 | 49/0/15 | 205.6 |
