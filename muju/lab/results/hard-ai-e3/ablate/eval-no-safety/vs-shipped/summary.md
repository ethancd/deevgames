# Ladder: hard@ablate:eval-no-safety vs aiv2-hard

- status: **complete**
- work: `wall:3000`, handicaps: `0,3`, seed: 20260933, shards: 4
...
- A record (W/D/L): 181/1/18
- adjudicationRate: 0.00%
- illegalActions: 0, replicaDivergences: 0, timingAnomalies: 0
- bothSeatsPlayed: true, seatMirrored: true
- Elo (A vs B): 396.7 [329.9, 494.8], LOS 100.0%, n = 100 pairs / 200 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1814.0 b=2990.1
- loadAvgMean (1-min, per game, start and end): 10.04
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-no-safety | 4212 | 3002 | 3200 | 492 | 3 | 0.07% | 0 | 0 |
| aiv2-hard | 4136 | 3005 | 3108 | 4084 | 6 | 0.15% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-no-safety | 4212 | 557 | 13.22% | 155 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 50/50 | 100 | 0.890 | 89/0/11 | 363.2 |
| 3 | 50/50 | 100 | 0.925 | 92/1/7 | 436.4 |
