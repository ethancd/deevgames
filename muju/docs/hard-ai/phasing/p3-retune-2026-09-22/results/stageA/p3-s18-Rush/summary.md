...
- Elo (A vs B): 137.0 [-77.3, 720.2], LOS 89.2%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1244.5 b=6.9
- loadAvgMean (1-min, per game, start and end): 4.93
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 570 | 1966 | 2323 | 0 | 0 | n/a | 0 | 0 |
| Rush | 573 | 30 | 80 | 0 | 0 | n/a | n/a | n/a |
