...
- meanTurnMs: a=470.8 b=1.1
- loadAvgMean (1-min, per game, start and end): 29.35
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 129 | 931 | 1367 | 0 | 0 | n/a | 0 | 0 |
| Balanced | 131 | 3 | 11 | 0 | 0 | n/a | n/a | n/a |
