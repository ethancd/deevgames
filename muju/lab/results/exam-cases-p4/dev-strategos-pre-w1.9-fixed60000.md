...
- run at 2026-09-24T20:44:52.489Z on The-Work-Box.local (node v24.11.1)
...
| --- | ---: | ---: | --- | --- | --- | --- | --- |
| `wave1-AS01-W-t3` | 5 (5) | 30–13 | damaging-attack | pass | FAIL (unexpected) | EA · EP | no attack in the turn |
