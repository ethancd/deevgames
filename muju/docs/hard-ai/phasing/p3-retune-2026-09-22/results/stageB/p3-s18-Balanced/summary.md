...
- meanTurnMs: a=456.5 b=0.9
- loadAvgMean (1-min, per game, start and end): 11.41
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 99 | 811 | 967 | 0 | 0 | n/a | 0 | 0 |
| Balanced | 103 | 3 | 7 | 0 | 0 | n/a | n/a | n/a |
