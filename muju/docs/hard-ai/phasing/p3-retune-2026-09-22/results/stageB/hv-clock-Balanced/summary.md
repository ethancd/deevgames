...
- meanTurnMs: a=429.7 b=0.8
- loadAvgMean (1-min, per game, start and end): 7.91
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 111 | 778 | 838 | 0 | 0 | n/a | 0 | 0 |
| Balanced | 115 | 3 | 8 | 0 | 0 | n/a | n/a | n/a |
