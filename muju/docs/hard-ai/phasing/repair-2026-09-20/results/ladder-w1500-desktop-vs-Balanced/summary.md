# Ladder: hard@desktop vs Balanced

- status: **complete**
- work: `wall:1500`, handicaps: `0`, seed: 35, shards: 8
...
- Elo (A vs B): 596.5 [400.7, 1199.8], LOS 100.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1022.6 b=1.8
- loadAvgMean (1-min, per game, start and end): 10.20
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 486 | 1505 | 1539 | 71 | 7 | 1.44% | 0 | 0 |
| Balanced | 490 | 6 | 36 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 486 | 74 | 15.23% | 31 | 0 |
