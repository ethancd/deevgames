...
Evidence: the adviser's best end key 9693d7fa61b4fb92 IS among the 19 candidates at this root; the engine played a932c749eddb7013 instead, worth -2069 cc to the adviser against -1522 cc. root exposure: 19 candidate(s) from a `completed-depth` list, 19 searched, completed depth 3, cutoff at -1. The root searched the adviser's best turn (candidate #6) and scored it -1179 cc, ABOVE the played candidate #0 at -2306 cc — so this re-run did not play what the seat played (it chose candidate #3 at -1179 cc). The re-run is fixed work and the seat played under a wall clock, which is the expected cause; the exposure describes the re-run, not the seat's own search
...
Evidence: the adviser's best end key cb22af454b144edc IS among the 29 candidates at this root; the engine played 5a757949d9cee1dd instead, worth -46 cc to the adviser against 2471 cc. root exposure: 29 candidate(s) from a `completed-depth` list, 29 searched, completed depth 3, cutoff at -1. The root searched the adviser's best turn (candidate #14) and scored it 2933 cc, ABOVE the played candidate #0 at 437 cc — so this re-run did not play what the seat played (it chose candidate #19 at 3265 cc). The re-run is fixed work and the seat played under a wall clock, which is the expected cause; the exposure describes the re-run, not the seat's own search
