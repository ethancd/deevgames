...
- distinctGames: A-white 15, B-white 16 of 16 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 16/16, games: 32/32 (missing 0, failed 0)
- A record (W/D/L): 26/0/6
...
- Elo (A vs B): 254.7 [142.2, 452.3], LOS 100.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3509.4 b=5933.3
- loadAvgMean (1-min, per game, start and end): 5.10
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 353 | 6002 | 6013 | 27 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 345 | 6013 | 6022 | 313 | 0 | 0.00% | n/a | n/a |
