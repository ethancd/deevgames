...
- status: **complete**
- work: `wall:6000`, handicaps: `0`, seed: 20260972, shards: 4
...
- distinctGames: A-white 29, B-white 31 of 32 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 32/32, games: 64/64 (missing 0, failed 0)
- A record (W/D/L): 49/1/14
...
- Elo (A vs B): 213.3 [129.5, 328.3], LOS 100.0%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3410.3 b=5961.9
- loadAvgMean (1-min, per game, start and end): 6.29
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 707 | 6001 | 6011 | 47 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 689 | 6013 | 6031 | 632 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 32/32 | 64 | 0.773 | 49/1/14 | 213.3 |
