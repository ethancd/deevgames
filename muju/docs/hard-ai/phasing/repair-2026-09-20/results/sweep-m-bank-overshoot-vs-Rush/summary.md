...
- **VOID** timing.a.overrunRate 17.77% (186/1047 turns) for arm a = hard@desktop exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- Elo (A vs B): -221.1 [-526.0, -76.8], LOS 0.1%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1193.5 b=40.9
- loadAvgMean (1-min, per game, start and end): 14.11
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 1047 | 1546 | 1678 | 420 | 186 | 17.77% | 0 | 0 |
| Rush | 1060 | 145 | 376 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 1047 | 425 | 40.59% | 32 | 0 |
