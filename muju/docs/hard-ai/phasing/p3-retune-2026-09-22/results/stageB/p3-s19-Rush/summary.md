...
- Elo (A vs B): -190.8 [-919.4, -3.5], LOS 2.3%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1131.7 b=10.6
- loadAvgMean (1-min, per game, start and end): 13.17
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 544 | 1904 | 2166 | 0 | 0 | n/a | 0 | 0 |
| Rush | 550 | 42 | 89 | 0 | 0 | n/a | n/a | n/a |
