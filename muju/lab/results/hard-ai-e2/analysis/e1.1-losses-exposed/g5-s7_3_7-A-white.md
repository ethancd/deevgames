...
Evidence: the adviser's best end key 05b0c06e62f7726c IS among the 29 candidates at this root; the engine played ff62fc2285f6bed1 instead, worth 2911 cc to the adviser against 3797 cc. root exposure: 29 candidate(s) from a `completed-depth` list, 29 searched, completed depth 3, cutoff at -1. The root searched the adviser's best turn (candidate #23) and scored it 3522 cc, ABOVE the played candidate #0 at 2314 cc — so this re-run did not play what the seat played (it chose candidate #23 at 3522 cc). The re-run is fixed work and the seat played under a wall clock, which is the expected cause; the exposure describes the re-run, not the seat's own search
...
Evidence: the adviser's best end key a01410167df2b37a IS among the 29 candidates at this root; the engine played e2c58b11e124265c instead, worth 4868 cc to the adviser against 9456 cc. root exposure: 29 candidate(s) from a `completed-depth` list, 29 searched, completed depth 3, cutoff at -1. The root searched the adviser's best turn (candidate #0) and scored it 7385 cc, below the played candidate #14 at 7891 cc
