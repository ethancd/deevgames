...
- distinctGames: A-white 31, B-white 30 of 32 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 32/32, games: 64/64 (missing 0, failed 0)
- A record (W/D/L): 46/0/18
...
- Elo (A vs B): 163.0 [80.1, 268.5], LOS 100.0%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3557.8 b=5952.3
- loadAvgMean (1-min, per game, start and end): 5.20
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 648 | 6002 | 6011 | 61 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 635 | 6013 | 6028 | 589 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 32/32 | 64 | 0.719 | 46/0/18 | 163.0 |
