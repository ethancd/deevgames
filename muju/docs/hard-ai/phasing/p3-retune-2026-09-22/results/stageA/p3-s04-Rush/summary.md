...
- Elo (A vs B): -190.8 [-432.1, -53.8], LOS 0.2%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=2573.9 b=20.9
- loadAvgMean (1-min, per game, start and end): 38.53
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 523 | 8205 | 16291 | 0 | 0 | n/a | 0 | 0 |
| Rush | 527 | 96 | 393 | 0 | 0 | n/a | n/a | n/a |
