# Ladder: hard@lab-refined vs aiv2-hard-turn

- status: **complete**
- work: `wall:1500`, handicaps: `0`, seed: 43, shards: 8
...
- A record (W/D/L): 1/1/30
- adjudicationRate: 0.00%
- **VOID** timing.b.overrunRate 37.50% (135/360 turns) for arm b = aiv2-hard-turn exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- Elo (A vs B): -523.3 [-1199.8, -360.8], LOS 0.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1038.1 b=1448.5
- loadAvgMean (1-min, per game, start and end): 25.18
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@lab-refined | 345 | 1515 | 1538 | 73 | 17 | 4.93% | 0 | 0 |
| aiv2-hard-turn | 360 | 1533 | 1593 | 338 | 135 | 37.50% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@lab-refined | 345 | 74 | 21.45% | 31 | 0 |
