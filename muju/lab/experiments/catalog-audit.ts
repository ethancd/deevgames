...
const rows=UNIT_DEFINITIONS.map(d=>{
 ...
 const dominates=UNIT_DEFINITIONS.filter(o=>o.tier===d.tier&&o.id!==d.id&&
  ...
  o.cost<=d.cost&&o.buildTime<=d.buildTime&&o.attack>=d.attack&&o.defense>=d.defense&&o.speed>=d.speed&&o.mining>=d.mining&&
  (o.cost<d.cost||o.buildTime<d.buildTime||o.attack>d.attack||o.defense>d.defense||o.speed>d.speed||o.mining>d.mining)).map(o=>o.id);
