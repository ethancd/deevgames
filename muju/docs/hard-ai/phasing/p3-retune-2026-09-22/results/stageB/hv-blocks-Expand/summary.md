...
- meanTurnMs: a=549.0 b=0.6
- loadAvgMean (1-min, per game, start and end): 8.96
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 157 | 1080 | 1295 | 0 | 0 | n/a | 0 | 0 |
| Expand | 157 | 2 | 3 | 0 | 0 | n/a | n/a | n/a |
