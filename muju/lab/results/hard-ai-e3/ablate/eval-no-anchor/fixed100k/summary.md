# Ladder: hard@ablate:eval-no-anchor vs hard@desktop

- status: **complete**
- work: `fixed:100000`, handicaps: `0,3`, seed: 37, shards: 1
...
- Elo (A vs B): 43.7 [-36.3, 128.6], LOS 85.7%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=2457.1 b=1693.7
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-no-anchor | 554 | 1745 | 408139 | 0 | 0 | n/a | 0 | 0 |
| hard@desktop | 553 | 1749 | 123452 | 0 | 0 | n/a | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-no-anchor | 554 | 0 | 0.00% | 0 | 0 |
| hard@desktop | 553 | 0 | 0.00% | 0 | 0 |
