# Ladder: Rush vs Balanced

- status: **complete**
- work: `wall:1500`, handicaps: `0`, seed: 44, shards: 8
...
- Elo (A vs B): 719.7 [529.6, 1199.8], LOS 100.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=60.3 b=4.3
- loadAvgMean (1-min, per game, start and end): 30.91
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Rush | 503 | 202 | 458 | 0 | 0 | 0.00% | n/a | n/a |
| Balanced | 509 | 19 | 59 | 0 | 0 | 0.00% | n/a | n/a |
