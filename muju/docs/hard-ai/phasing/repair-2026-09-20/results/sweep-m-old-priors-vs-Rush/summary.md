...
- **VOID** timing.a.overrunRate 14.84% (152/1024 turns) for arm a = hard@desktop exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- meanTurnMs: a=1200.8 b=37.8
- loadAvgMean (1-min, per game, start and end): 16.92
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 1024 | 1536 | 1666 | 362 | 152 | 14.84% | 0 | 0 |
| Rush | 1036 | 119 | 262 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 1024 | 360 | 35.16% | 32 | 0 |
