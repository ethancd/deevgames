...
- distinctGames: A-white 29, B-white 29 of 32 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 32/32, games: 64/64 (missing 0, failed 0)
- A record (W/D/L): 44/0/20
...
- Elo (A vs B): 137.0 [65.5, 221.8], LOS 100.0%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3470.8 b=5929.6
- loadAvgMean (1-min, per game, start and end): 5.58
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 631 | 6001 | 6012 | 39 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 621 | 6013 | 6110 | 573 | 1 | 0.16% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 32/32 | 64 | 0.688 | 44/0/20 | 137.0 |
