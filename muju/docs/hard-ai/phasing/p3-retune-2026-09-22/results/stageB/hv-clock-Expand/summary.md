...
- meanTurnMs: a=542.0 b=0.6
- loadAvgMean (1-min, per game, start and end): 11.09
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 139 | 1061 | 1242 | 0 | 0 | n/a | 0 | 0 |
| Expand | 142 | 2 | 5 | 0 | 0 | n/a | n/a | n/a |
