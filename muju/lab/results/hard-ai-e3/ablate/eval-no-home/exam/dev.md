# Muju examination set — dev stratum, hard@ablate:eval-no-home

- run at 2026-09-17T03:12:45.961Z on The-Work-Box.local (node v24.11.1)
- work: fixed 25000 units; config `hard:ablate:eval-no-home:fixed:25000#58b76a5d48b254b4024c8ba0536fba0bbec619c64d2002a7d9831debffdf8af7`
...
| `immediate-action` | 24/28 | 0/1 | Immediate action after purchasing/promoting — see summon-and-strike, combined purchases/promotions and multiple promotions |
...
| `authored-spawn-strike-spawn-strike-purchase-1` | kill | `5c415de79983f548` | search | 2 |  |
| `authored-spawn-strike-spawn-strike-purchase-4` | kill | `7f5e755a2eed16cb` | search | 2 |  |
| `authored-spawn-strike-spawn-strike-retreat-1` | kill | `ad52fc0d1b164bee` | search | 2 |  |
| `authored-spawn-strike-spawn-strike-retreat-4` | kill | `a7c6d0d662b18035` | search | 2 |  |
