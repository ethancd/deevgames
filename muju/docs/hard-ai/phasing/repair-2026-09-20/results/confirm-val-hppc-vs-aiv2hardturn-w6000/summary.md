...
- status: **complete**
- work: `wall:6000`, handicaps: `0`, seed: 51, shards: 8
...
- Elo (A vs B): 273.2 [161.3, 476.4], LOS 100.0%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3638.4 b=5965.6
- loadAvgMean (1-min, per game, start and end): 10.47
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:hand-priors-pc | 671 | 6006 | 6037 | 97 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 654 | 6020 | 6245 | 646 | 8 | 1.22% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:hand-priors-pc | 671 | 97 | 14.46% | 63 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 32/32 | 64 | 0.828 | 53/0/11 | 273.2 |
