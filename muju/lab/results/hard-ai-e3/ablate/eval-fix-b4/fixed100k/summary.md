# Ladder: hard@ablate:eval-fix-b4 vs hard@desktop

- status: **complete**
- work: `fixed:100000`, handicaps: `0,3`, seed: 41, shards: 1
...
- Elo (A vs B): 0.0 [-125.6, 125.6], LOS 50.0%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1203.7 b=1205.2
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-fix-b4 | 539 | 1913 | 6284 | 0 | 0 | n/a | 0 | 0 |
| hard@desktop | 539 | 1951 | 6420 | 0 | 0 | n/a | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-fix-b4 | 539 | 0 | 0.00% | 0 | 0 |
| hard@desktop | 539 | 0 | 0.00% | 0 | 0 |
