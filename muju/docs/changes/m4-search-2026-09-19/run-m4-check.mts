...
import { acquireHeavySlot, reassignSlot, heavyBypassed } from './deevgames-phasing-m4/muju/lab/hard-ai/ladder/heavy.ts';

const repo = '/Users/ashkie/Documents/Codex/2026-09-18/wba/work/deevgames-phasing-m4/muju';
...
const release = await acquireHeavySlot(`codex-m4-${label}`);
try {
