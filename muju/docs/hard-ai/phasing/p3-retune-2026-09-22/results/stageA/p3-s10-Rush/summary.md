...
- Elo (A vs B): 43.7 [-153.8, 279.1], LOS 67.5%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=4034.4 b=31.8
- loadAvgMean (1-min, per game, start and end): 22.61
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 420 | 7572 | 9827 | 0 | 0 | n/a | 0 | 0 |
| Rush | 424 | 124 | 212 | 0 | 0 | n/a | n/a | n/a |
