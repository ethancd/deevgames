...
- Elo (A vs B): -88.7 [-406.8, 117.0], LOS 19.7%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1099.2 b=8.8
- loadAvgMean (1-min, per game, start and end): 4.64
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 574 | 1857 | 2490 | 0 | 0 | n/a | 0 | 0 |
| Rush | 578 | 31 | 93 | 0 | 0 | n/a | n/a | n/a |
