...
<p class="tip" id="phasing-notice" role="note" aria-label="Phasing rules update" style="margin:0 0 30px"><strong>Turn-order update</strong><br>Lessons R01, R04–R07, R09 and R10 teach the previous Standard turn order. Phasing uses Act → Mine + Upkeep → Prepare. Purchases are public summons that arrive on your next turn if undisturbed; disrupted summons refund their cost. The quiet-turn draw is now twenty plies, not ten: lesson R09 still says ten, and its warning still turns amber at seven rather than seventeen. What resets the clock is unchanged — only an attack that removes a piece. These recordings have not yet been updated for Phasing.</p>
