...
Planning update: start with [the Hard AI epic plan](EPIC-PLAN-2026-09-16.md) for
the development sequence, experiment contract and release decisions. This update
adds planning only; no engine code or historical gate criteria changed.
