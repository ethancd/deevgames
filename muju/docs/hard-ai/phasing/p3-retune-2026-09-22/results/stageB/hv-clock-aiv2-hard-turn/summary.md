...
- Elo (A vs B): 137.0 [28.3, 280.9], LOS 99.4%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3784.9 b=5970.6
- loadAvgMean (1-min, per game, start and end): 5.36
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 330 | 6002 | 6008 | 37 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 325 | 6014 | 6019 | 308 | 0 | 0.00% | n/a | n/a |
