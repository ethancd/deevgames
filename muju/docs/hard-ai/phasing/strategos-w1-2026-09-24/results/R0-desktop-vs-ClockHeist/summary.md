# Ladder: hard@desktop vs ClockHeist
...
- distinctGames: A-white 141, B-white 103 of 192 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 192/192, games: 384/384 (missing 0, failed 0)
- A record (W/D/L): 364/3/17
...
- Elo (A vs B): 518.3 [448.3, 629.8], LOS 100.0%, n = 192 pairs / 384 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=599.8 b=0.4
- loadAvgMean (1-min, per game, start and end): 18.28
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 3075 | 1225 | 4549 | 0 | 0 | n/a | 0 | 0 |
| ClockHeist | 2986 | 1 | 56 | 0 | 0 | n/a | n/a | n/a |
...
| 4 | 32/32 | 64 | 0.969 | 62/0/2 | 596.5 |
| 8 | 32/32 | 64 | 0.953 | 60/2/2 | 523.3 |
| 12 | 32/32 | 64 | 0.930 | 59/1/4 | 448.5 |
| 16 | 32/32 | 64 | 0.938 | 60/0/4 | 470.4 |
| 20 | 32/32 | 64 | 0.938 | 60/0/4 | 470.4 |
