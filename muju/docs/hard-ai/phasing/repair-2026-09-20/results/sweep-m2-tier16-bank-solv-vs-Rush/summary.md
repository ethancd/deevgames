...
- A record (W/D/L): 11/0/21
- adjudicationRate: 3.13% — **VOIDED** (> 1%, SU addendum 2)
- **VOID** adjudicationRate 3.13% exceeds 1% (SU addendum 2)
...
- Elo (A vs B): -112.3 [-239.8, -9.3], LOS 1.6%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1000.4 b=28.0
- loadAvgMean (1-min, per game, start and end): 15.57
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 1155 | 1514 | 1595 | 219 | 50 | 4.33% | 0 | 0 |
| Rush | 1160 | 99 | 458 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 1155 | 218 | 18.87% | 30 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 16/16 | 32 | 0.344 | 11/0/21 | -112.3 |
