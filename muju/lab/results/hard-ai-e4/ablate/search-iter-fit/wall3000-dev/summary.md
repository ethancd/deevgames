# Ladder: hard@ablate:search-iter-fit vs hard@desktop

- status: **complete**
- work: `wall:3000`, handicaps: `0,3`, seed: 47, shards: 4
...
- A record (W/D/L): 7/0/9
- adjudicationRate: 0.00%
- illegalActions: 0, replicaDivergences: 0, timingAnomalies: 0
- bothSeatsPlayed: true, seatMirrored: true
- Elo (A vs B): -43.7 [-210.1, 103.9], LOS 27.8%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=2301.9 b=1844.4
- loadAvgMean (1-min, per game, start and end): 18.99
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:search-iter-fit | 476 | 3003 | 15245 | 73 | 7 | 1.47% | 0 | 0 |
| hard@desktop | 477 | 3002 | 14025 | 43 | 5 | 1.05% | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:search-iter-fit | 476 | 82 | 17.23% | 16 | 0 |
| hard@desktop | 477 | 49 | 10.27% | 14 | 0 |

## Per-handicap strata

| handicap | pairs | games | score (A) | W/D/L | Elo |
| --- | --- | --- | --- | --- | --- |
| 0 | 4/4 | 8 | 0.250 | 2/0/6 | -190.8 |
