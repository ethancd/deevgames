...
- meanTurnMs: a=512.1 b=0.6
- loadAvgMean (1-min, per game, start and end): 8.18
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 125 | 1083 | 1301 | 0 | 0 | n/a | 0 | 0 |
| Expand | 126 | 2 | 4 | 0 | 0 | n/a | n/a | n/a |
