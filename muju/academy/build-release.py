...
<p class="tip" id="kill-clock-notice" role="note" aria-label="Kill clock update" style="margin:0 0 30px"><strong>Kill clock — September 22, 2026</strong><br>The quiet-turn draw is retired. Ten kill-free player turns, not twenty, now end the game immediately, decided by each side's mined total — every crystal its units have taken from the board, plus Black's starting handicap — with the higher total winning and equal totals drawing; it is no longer always a draw. Lessons R09 (the draw lesson) and R10 still teach the retired twenty-ply always-a-draw rule, and R09's warning still turns amber at seventeen rather than seven. What resets the clock is unchanged — only an attack that removes a piece. These recordings have not yet been updated.</p>
<p class="tip" id="cleave-notice" role="note" aria-label="Cleave update" style="margin:0 0 30px"><strong>Cleave without a tier cap — September 23, 2026</strong><br>A killing blow still unlocks another attack by the same piece, but there is no longer a maximum by tier: every kill unlocks another, at any tier, as long as shared actions remain. A Tier 1 Hi beside four Muju can now take all four in one turn. A surviving target still ends the chain, and a teammate's kill still does not reopen it. Lesson R03 still teaches the old limit of one, two or three attacks by tier, and its Honō that "cannot attack a third time" could now attack again. These recordings have not yet been updated.</p>
