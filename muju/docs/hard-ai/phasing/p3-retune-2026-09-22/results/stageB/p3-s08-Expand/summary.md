...
- meanTurnMs: a=470.7 b=0.7
- loadAvgMean (1-min, per game, start and end): 14.91
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 109 | 977 | 1105 | 0 | 0 | n/a | 0 | 0 |
| Expand | 110 | 2 | 6 | 0 | 0 | n/a | n/a | n/a |
