...
- **VOID** timing.a.overrunRate 18.05% (148/820 turns) for arm a = hard@desktop exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- Elo (A vs B): -221.1 [-450.7, -94.0], LOS 0.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1206.4 b=47.3
- loadAvgMean (1-min, per game, start and end): 17.70
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 820 | 1542 | 1727 | 361 | 148 | 18.05% | 0 | 0 |
| Rush | 827 | 148 | 534 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 820 | 360 | 43.90% | 32 | 0 |
