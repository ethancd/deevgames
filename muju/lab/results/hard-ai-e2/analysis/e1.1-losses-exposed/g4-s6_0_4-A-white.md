...
Evidence: the adviser's best end key f19ab20217e49e6f IS among the 30 candidates at this root; the engine played aee340870423b0a4 instead, worth 3774 cc to the adviser against 4151 cc. root exposure: 30 candidate(s) from a `completed-depth` list, 30 searched, completed depth 3, cutoff at -1. The root searched the adviser's best turn (candidate #16) and scored it 5025 cc, ABOVE the played candidate #0 at 4037 cc — so this re-run did not play what the seat played (it chose candidate #23 at 5175 cc). The re-run is fixed work and the seat played under a wall clock, which is the expected cause; the exposure describes the re-run, not the seat's own search

### Largest swing

**fixed-work-divergence** at turn 28 (the seat's turn #28).

Rule: the fixed-work re-run did not play what the seat played (`engine.reproducedPlayed` false) AND it scored the adviser's best turn strictly above the played candidate. The engine prefers the better turn when it is given this much work; the seat, under a wall clock at a coarser rung, did not. This is a statement about the WORK the seat had, not about its judgement, and it is not evidence that the seat would have found the turn in its allowance — `E2-LANE2-EXPOSED-LOSSES.md`'s work sweep is what tests that

Evidence: the adviser's best end key db8b7fb51b5487f3 IS among the 25 candidates at this root; the engine played b1c33ff005911e3e instead, worth -9505 cc to the adviser against -2686 cc. root exposure: 25 candidate(s) from a `completed-depth` list, 25 searched, completed depth 3, cutoff at -1. The root searched the adviser's best turn (candidate #21) and scored it -1295 cc, ABOVE the played candidate #0 at -7301 cc — so this re-run did not play what the seat played (it chose candidate #22 at -1149 cc). The re-run is fixed work and the seat played under a wall clock, which is the expected cause; the exposure describes the re-run, not the seat's own search
