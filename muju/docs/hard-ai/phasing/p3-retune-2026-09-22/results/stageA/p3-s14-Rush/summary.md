...
- status: **complete**
- work: `fixed:60000`, handicaps: `0`, seed: 20260970, shards: 2
...
- Elo (A vs B): -43.7 [-279.1, 153.8], LOS 32.5%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3222.3 b=21.9
- loadAvgMean (1-min, per game, start and end): 57.34
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 578 | 8535 | 19736 | 0 | 0 | n/a | 0 | 0 |
| Rush | 581 | 95 | 374 | 0 | 0 | n/a | n/a | n/a |
