...
const pronounce=t=>t.replace(/\bHi\b/g,'Hee').replace(/\bSjor\b/g,'Shore').replace(/\b([A-J]) (one|two|three|four|five|six|seven|eight|nine|ten)\b/g,(_,c,n)=>({A:'Ay',B:'Bee',C:'See',D:'Dee',E:'Ee',F:'Eff',G:'Gee',H:'Aitch',I:'Eye',J:'Jay'}[c]+'-'+n));
