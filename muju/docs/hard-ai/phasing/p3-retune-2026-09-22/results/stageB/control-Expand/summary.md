...
- distinctGames: A-white 7, B-white 8 of 8 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
...
- meanTurnMs: a=602.3 b=0.9
- loadAvgMean (1-min, per game, start and end): 22.03
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 124 | 1112 | 1365 | 0 | 0 | n/a | 0 | 0 |
| Expand | 128 | 2 | 13 | 0 | 0 | n/a | n/a | n/a |
