...
- status: **complete**
- work: `wall:6000`, handicaps: `0`, seed: 20260975, shards: 4
...
- distinctGames: A-white 30, B-white 32 of 32 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 32/32, games: 64/64 (missing 0, failed 0)
- A record (W/D/L): 54/0/10
...
- Elo (A vs B): 293.0 [193.2, 463.1], LOS 100.0%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3462.2 b=5973.7
- loadAvgMean (1-min, per game, start and end): 7.54
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 696 | 6001 | 6011 | 41 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 678 | 6014 | 6029 | 638 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 32/32 | 64 | 0.844 | 54/0/10 | 293.0 |
