...
- meanTurnMs: a=553.4 b=0.7
- loadAvgMean (1-min, per game, start and end): 13.82
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 152 | 1019 | 1304 | 0 | 0 | n/a | 0 | 0 |
| Expand | 155 | 2 | 5 | 0 | 0 | n/a | n/a | n/a |
