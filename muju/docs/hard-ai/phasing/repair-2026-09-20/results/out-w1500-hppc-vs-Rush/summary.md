# Ladder: hard@ablate:hand-priors-pc vs Rush
...
- **VOID** timing.a.overrunRate 16.99% (142/836 turns) for arm a = hard@ablate:hand-priors-pc exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- Elo (A vs B): -88.7 [-202.1, 8.3], LOS 3.7%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1194.5 b=40.9
- loadAvgMean (1-min, per game, start and end): 12.56
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:hand-priors-pc | 836 | 1535 | 1647 | 326 | 142 | 16.99% | 0 | 0 |
| Rush | 845 | 141 | 232 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:hand-priors-pc | 836 | 324 | 38.76% | 32 | 0 |
