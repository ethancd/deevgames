...
- A record (W/D/L): 10/1/21
- adjudicationRate: 0.00%
- **VOID** timing.a.overrunRate 8.36% (112/1340 turns) for arm a = hard@desktop exceeds the 5% ceiling (AMENDMENTS-DECIDED A14): this comparison row is VOID
...
- Elo (A vs B): -124.5 [-256.1, -20.9], LOS 0.9%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=997.9 b=18.2
- loadAvgMean (1-min, per game, start and end): 12.51
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 1340 | 1532 | 2063 | 273 | 112 | 8.36% | 0 | 0 |
| Rush | 1332 | 71 | 451 | 0 | 0 | 0.00% | n/a | n/a |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 1340 | 273 | 20.37% | 32 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 0 | 16/16 | 32 | 0.328 | 10/1/21 | -124.5 |
