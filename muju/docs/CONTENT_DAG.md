...
commands and pending status for automation. All planner commands are read-only;
...
`check` validates acyclicity, dependencies and declared local paths. It does not
