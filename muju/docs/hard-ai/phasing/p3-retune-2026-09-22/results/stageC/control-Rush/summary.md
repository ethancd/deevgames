...
- status: **complete**
- work: `fixed:60000`, handicaps: `0`, seed: 20260972, shards: 4
...
- distinctGames: A-white 32, B-white 31 of 32 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
...
- Elo (A vs B): -54.7 [-148.4, 31.5], LOS 10.7%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1147.9 b=11.0
- loadAvgMean (1-min, per game, start and end): 11.08
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 1672 | 1930 | 2401 | 0 | 0 | n/a | 0 | 0 |
| Rush | 1691 | 37 | 116 | 0 | 0 | n/a | n/a | n/a |
