...
- distinctGames: A-white 16, B-white 15 of 16 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 16/16, games: 32/32 (missing 0, failed 0)
- A record (W/D/L): 25/0/7
...
- Elo (A vs B): 221.1 [94.0, 450.7], LOS 100.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3576.7 b=5932.8
- loadAvgMean (1-min, per game, start and end): 6.94
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 332 | 6002 | 6011 | 37 | 0 | 0.00% | 0 | 0 |
| aiv2-hard-turn | 323 | 6013 | 6048 | 300 | 0 | 0.00% | n/a | n/a |
