...
- meanTurnMs: a=419.8 b=0.7
- loadAvgMean (1-min, per game, start and end): 9.13
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 106 | 790 | 1037 | 0 | 0 | n/a | 0 | 0 |
| Balanced | 109 | 2 | 4 | 0 | 0 | n/a | n/a | n/a |
