# Ladder: hard@desktop vs hard@env

- status: **complete**
- work: `fixed:60000`, handicaps: `0`, seed: 20260977, shards: 4
...
- distinctGames: A-white 31, B-white 31 of 32 pair(s) (digested from the games.jsonl turns/plies/winType tuple, which is coarser) — **DUPLICATE OPENINGS**: pairs replayed the same game, so they are not independent observations
- pairs: 32/32, games: 64/64 (missing 0, failed 0)
- A record (W/D/L): 32/0/32
...
- Elo (A vs B): 0.0 [-22.9, 22.9], LOS 50.0%, n = 32 pairs / 64 games **(degenerate sample, regularized - descriptive only)**
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=734.9 b=735.2
- loadAvgMean (1-min, per game, start and end): 5.07
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@desktop | 1475 | 1266 | 1705 | 0 | 0 | n/a | 0 | 0 |
| hard@env | 1475 | 1272 | 1774 | 0 | 0 | n/a | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| hard@desktop | 1475 | 0 | 0.00% | 0 | 0 |
| hard@env | 1475 | 0 | 0.00% | 0 | 0 |

## Per-handicap strata

| handicap | pairs | games | score (A) | W/D/L | Elo |
| --- | --- | --- | --- | --- | --- |
| 0 | 32/32 | 64 | 0.500 | 32/0/32 | 0.0 |
