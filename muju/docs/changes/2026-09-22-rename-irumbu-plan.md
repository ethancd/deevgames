...
## 1. [ ] catalogue — Canonical piece definitions and elemental relationships
...
## 2. [ ] transitions — Canonical legality and state transitions
...
## 3. [ ] rules-docs — Current rules, AI explanation and public design copy
...
## 4. [ ] browser-ui — Browser controls, instructions and visual representations
...
## 5. [ ] persistence — Saved games, migrations, history and replay compatibility
...
## 6. [ ] wasm-tactics — Compiled tactical solver and canonical witness validation
...
## 7. [ ] ai-search — Deterministic game AI, evaluation, planning and worker
...
## 8. [ ] hard-ai — Hard engine: packed rules replica, turn generator, prover, evaluation and search
...
## 9. [ ] ai-strength — AI correctness veto and preregistered strength evidence
...
## 10. [ ] server-runtime — Authoritative multiplayer host, schemas and online client
...
## 11. [ ] mcp-tools — MCP rules, legal actions, previews and analysis helpers

Reason: change kind: mcp; upstream changed: server-runtime; upstream changed: ai-search
...
## 12. [ ] agent-guides — Published agent skills and MCP usage documentation
...
## 13. [ ] balance-analysis — Current static balance report and relevant fresh experiments
...
## 14. [ ] academy-data — Academy current rule snapshots, catalogues, map and matchup matrices
...
## 15. [ ] academy-lessons — Academy lesson scripts, examples and renderer sources

Reason: change kind: academy; upstream changed: academy-data; upstream changed: rules-docs; upstream changed: browser-ui; upstream changed: server-runtime
...
## 16. [ ] academy-audio — Academy narration, local transcription and caption timing
...
## 17. [ ] academy-video — Final videos, mastering, posters, transcripts and visual QA
...
## 18. [ ] game-validation — Game, AI, server, MCP and browser regression gates

Reason: change kind: release; upstream changed: rules-docs; upstream changed: browser-ui; upstream changed: persistence; upstream changed: wasm-tactics; upstream changed: ai-search; upstream changed: hard-ai; upstream changed: ai-strength; upstream changed: server-runtime; upstream changed: mcp-tools; upstream changed: agent-guides; upstream changed: balance-analysis
...
## 19. [ ] static-package — Complete deevgames static release artifact
...
## 20. [ ] server-package — Node host release with persistent room storage
...
## 21. [ ] academy-package — Versioned Academy site package and historical redirects
...
## 22. [ ] static-deploy — Publish Cloudflare Pages deevgames
...
## 23. [ ] server-deploy — Publish authoritative multiplayer/MCP host
...
## 24. [ ] academy-deploy — Publish Muju Academy on ashkie.com
...
## 25. [ ] release-verification — Cross-surface completion evidence
