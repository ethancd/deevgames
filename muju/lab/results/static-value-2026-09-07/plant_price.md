# Static value solver: plant_price

Catalogue SHA-256: `f652b04139673d1b89f4841da6bbd71bfccc58c0842212f356140d1f7e890abf`. Model SHA-256: `859f0b67455c80190450c895cbad154e27742f22a4c46c01b4347e80f1d48940`.
...
|---|---|---|---|---:|---|
| Hi (fire_1) | 2/1/2/1 | 1/1 | none | 2572 / 1516 | strike fire_1 at distance 1 within 2 actions; mine >=1 fresh layers first; survive no hit |
| Hono (fire_2) | 3/1/2/1 | 3/1 | none | 1198 / 910 | strike fire_4 at distance 1 within 1 actions; mine >=0 fresh layers first; survive plant_2 hit |
| Kagari (fire_3) | 4/2/3/1 | 6/2 | none | 7463 / 5947 | strike fire_1 at distance 3 within 2 actions; mine >=0 fresh layers first; survive plant_3 hit |
| Gokamoka (fire_4) | 6/3/4/1 | 10/2 | none | 14067 / 11276 | strike fire_1 at distance 3 within 2 actions; mine >=0 fresh layers first; survive plant_4 hit |
| Radi (lightning_1) | 1/1/3/0 | 1/1 | none | 1500 / 444 | strike fire_1 at distance 4 within 2 actions; mine >=0 fresh layers first; survive no hit |
| Umeme (lightning_2) | 2/1/4/0 | 3/1 | none | 684 / 684 | strike fire_1 at distance 5 within 2 actions; mine >=0 fresh layers first; survive no hit |
| Kimubunga (lightning_3) | 2/1/5/1 | 6/2 | none | 1384 / 984 | strike fire_1 at distance 5 within 3 actions; mine >=1 fresh layers first; survive no hit |
| Dhorubakali (lightning_4) | 3/1/6/1 | 10/2 | none | 1712 / 1096 | strike fire_1 at distance 7 within 2 actions; mine >=0 fresh layers first; survive no hit |
| Sjor (water_1) | 2/2/1/2 | 2/1 | none | 3378 / 2136 | strike fire_1 at distance 1 within 2 actions; mine >=1 fresh layers first; survive fire_1 hit |
| Straumr (water_2) | 2/3/1/2 | 4/2 | none | 2776 / 2776 | strike fire_1 at distance 1 within 1 actions; mine >=0 fresh layers first; survive fire_2 hit |
| Aegirinn (water_3) | 3/4/2/3 | 10/2 | none | 11451 / 10551 | strike fire_1 at distance 1 within 1 actions; mine >=0 fresh layers first; survive fire_3 hit |
| Hafkafstormur (water_4) | 4/5/3/3 | 15/3 | none | 16070 / 11945 | strike fire_1 at distance 3 within 2 actions; mine >=0 fresh layers first; survive water_4 hit |
| Göl (shadow_1) | 2/2/2/0 | 2/1 | none | 2136 / 894 | strike fire_1 at distance 3 within 2 actions; mine >=0 fresh layers first; survive fire_1 hit |
| Gölge (shadow_2) | 3/2/2/1 | 4/2 | none | 1456 / 1456 | strike fire_1 at distance 3 within 3 actions; mine >=1 fresh layers first; survive fire_1 hit |
| Karanlık (shadow_3) | 4/2/3/2 | 10/2 | none | 4605 / 1530 | strike fire_1 at distance 4 within 3 actions; mine >=2 fresh layers first; survive no hit |
| Karabasan (shadow_4) | 5/3/4/2 | 15/3 | none | 11850 / 7725 | strike fire_1 at distance 5 within 2 actions; mine >=0 fresh layers first; survive fire_2 hit |
| Muju (plant_1) | 0/2/1/3 | 3/2 | none | 299 / 133 | mine >=3 in fresh corridor within 1 actions; survive no hit |
| Sachita (plant_2) | 1/3/1/3 | 5/2 | none | 894 / 894 | strike water_1 at distance 1 within 2 actions; mine >=3 fresh layers first; survive no hit |
| Sachakuna (plant_3) | 2/4/1/4 | 9/3 | none | 4520 / 4520 | strike fire_1 at distance 1 within 2 actions; mine >=4 fresh layers first; survive no hit |
| Cuauhtlimallki (plant_4) | 3/5/1/5 | 14/3 | none | 11734 / 11734 | strike fire_1 at distance 1 within 2 actions; mine >=4 fresh layers first; survive fire_2 hit |
...
| Mazaska (metal_2) | 2/4/1/3 | 6/2 | none | 9339 / 8223 | strike fire_1 at distance 1 within 1 actions; mine >=0 fresh layers first; survive water_3 hit |
...
| Wakanwicasa (metal_4) | 3/8/1/4 | 20/3 | none | 1755 / 1755 | strike fire_1 at distance 1 within 1 actions; mine >=0 fresh layers first; survive fire_4 hit |
...
| lightning_1 | 36/1296 | 21/1296 / 0.67 | 3 / 2 / 0 | 1 → 1 | 9 |
| lightning_2 | 105/1296 | 30/1296 / 0.39 | 3 / 3 / 0 | 1 → 1 | 21 |
| lightning_3 | 126/1296 | 30/1296 / 0.28 | 3 / 3 / 0 | 1 → 1 | 21 |
| lightning_4 | 63/1296 | 51/1296 / 0.17 | 3 / 3 / 0 | 1 → 1 | 9 |
...
| lightning_1 | 0.37 (43 cases) | 21/72 | fire_3, distance 1: 2 → 1 crystals |
| lightning_2 | 1.36 (64 cases) | 7/72 | fire_4, distance 1: 6 → 3 crystals |
| lightning_3 | 2.72 (64 cases) | 7/72 | fire_4, distance 1: 12 → 6 crystals |
| lightning_4 | 1.67 (72 cases) | 0/72 | water_2, distance 1: 20 → 10 crystals |
...
| plant_2 | 2.94 (17 cases) | 20/72 | fire_1, distance 1: infeasible → 5 crystals |
| plant_3 | 1.95 (37 cases) | 4/72 | fire_3, distance 1: 18 → 9 crystals |
| plant_4 | 1.71 (41 cases) | 4/72 | fire_4, distance 1: 28 → 14 crystals |
