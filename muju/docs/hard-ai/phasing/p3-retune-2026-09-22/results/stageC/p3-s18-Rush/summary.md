...
- Elo (A vs B): -32.7 [-124.7, 54.9], LOS 23.2%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1232.8 b=7.8
- loadAvgMean (1-min, per game, start and end): 11.12
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 2108 | 2014 | 2580 | 0 | 0 | n/a | 0 | 0 |
| Rush | 2124 | 30 | 84 | 0 | 0 | n/a | n/a | n/a |
