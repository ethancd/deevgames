...
- Elo (A vs B): -21.7 [-110.0, 63.8], LOS 30.8%, n = 32 pairs / 64 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1206.4 b=9.4
- loadAvgMean (1-min, per game, start and end): 11.79
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 2056 | 2038 | 2595 | 0 | 0 | n/a | 0 | 0 |
| Rush | 2067 | 36 | 99 | 0 | 0 | n/a | n/a | n/a |
