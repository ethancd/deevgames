# Ladder: hard@ablate:eval-fix-b2 vs hard@desktop

- status: **complete**
- work: `fixed:100000`, handicaps: `0,3`, seed: 39, shards: 1
...
- Elo (A vs B): -43.7 [-128.6, 36.3], LOS 14.3%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1220.4 b=1161.6
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-fix-b2 | 494 | 1843 | 17161 | 0 | 0 | n/a | 0 | 0 |
| hard@desktop | 496 | 1854 | 7303 | 0 | 0 | n/a | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-fix-b2 | 494 | 0 | 0.00% | 0 | 0 |
| hard@desktop | 496 | 0 | 0.00% | 0 | 0 |
