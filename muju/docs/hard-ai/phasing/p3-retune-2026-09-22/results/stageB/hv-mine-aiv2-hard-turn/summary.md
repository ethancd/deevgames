...
- Elo (A vs B): 190.8 [90.6, 334.1], LOS 100.0%, n = 16 pairs / 32 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=3594.4 b=5967.2
- loadAvgMean (1-min, per game, start and end): 14.04
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 318 | 6001 | 6112 | 28 | 1 | 0.31% | 0 | 0 |
| aiv2-hard-turn | 312 | 6015 | 6039 | 290 | 0 | 0.00% | n/a | n/a |
