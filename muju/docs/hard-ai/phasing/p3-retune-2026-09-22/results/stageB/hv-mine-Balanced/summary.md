...
- Elo (A vs B): 596.5 [405.0, 1199.8], LOS 100.0%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=457.2 b=0.8
- loadAvgMean (1-min, per game, start and end): 10.71
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@env | 101 | 728 | 1062 | 0 | 0 | n/a | 0 | 0 |
| Balanced | 108 | 2 | 4 | 0 | 0 | n/a | n/a | n/a |
