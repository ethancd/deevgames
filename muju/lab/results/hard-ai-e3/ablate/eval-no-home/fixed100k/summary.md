# Ladder: hard@ablate:eval-no-home vs hard@desktop

- status: **complete**
- work: `fixed:100000`, handicaps: `0,3`, seed: 31, shards: 1
...
- Elo (A vs B): -43.7 [-352.3, 199.0], LOS 35.1%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1321.4 b=1266.1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-no-home | 564 | 1749 | 96955 | 0 | 0 | n/a | 0 | 0 |
| hard@desktop | 564 | 1871 | 41165 | 0 | 0 | n/a | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:eval-no-home | 564 | 0 | 0.00% | 0 | 0 |
| hard@desktop | 564 | 0 | 0.00% | 0 | 0 |

## Per-handicap strata

| handicap | pairs | games | score (A) | W/D/L | Elo |
| --- | --- | --- | --- | --- | --- |
| 0 | 4/4 | 8 | 0.375 | 3/0/5 | -88.7 |
