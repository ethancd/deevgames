# Ladder: hard@ablate:search-tie-break vs hard@desktop

- status: **complete**
- work: `fixed:100000`, handicaps: `0,3`, seed: 45, shards: 4
...
- A record (W/D/L): 5/0/11
- adjudicationRate: 0.00%
- illegalActions: 0, replicaDivergences: 0, timingAnomalies: 0
- bothSeatsPlayed: true, seatMirrored: true
- Elo (A vs B): -137.0 [-308.6, -13.7], LOS 1.4%, n = 8 pairs / 16 games
- SPRT: not requested
- SPRT (sequential): not requested
- meanTurnMs: a=1250.2 b=1479.4
- loadAvgMean (1-min, per game, start and end): 12.82
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hard@ablate:search-tie-break | 490 | 1960 | 21258 | 0 | 0 | n/a | 0 | 0 |
| hard@desktop | 493 | 1821 | 111173 | 0 | 0 | n/a | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| hard@ablate:search-tie-break | 490 | 0 | 0.00% | 0 | 0 |
| hard@desktop | 493 | 0 | 0.00% | 0 | 0 |
